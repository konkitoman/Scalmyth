...
public class ModTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SCALMYTH_TAB = REGISTRY.register("scalmyth_tab",
            () -> CreativeModeTab.builder().title(Component.translatable("item_group.scalmyth.scalmyth_tab")).icon(() -> new ItemStack(ModBlocks.ASHEN_GRASS.get())).displayItems(
                    (parameters, tabData) -> {
                tabData.accept(ModBlocks.ASHEN_GRASS.get().asItem());
    ...
    public static void buildTabContentsVanilla(BuildCreativeModeTabContentsEvent tabData) {
        if (tabData.getTabKey() == CreativeModeTabs.SPAWN_EGGS) {
            tabData.accept(ModItems.SCALMYTH_SPAWN_EGG.get());
        } else if (tabData.getTabKey() == CreativeModeTabs.NATURAL_BLOCKS) {
            tabData.accept(ModBlocks.ASHEN_GRASS.get().asItem());
        } else if (tabData.getTabKey().equals(SCALMYTH_TAB.getKey())) {
            tabData.accept(ModItems.SCALMYTH_SPAWN_EGG.get().asItem());
            tabData.accept(ModItems.ASHEN_SHORT_GRASS.get().asItem());
            tabData.accept(ModItems.ASHEN_TALL_GRASS.get().asItem());
